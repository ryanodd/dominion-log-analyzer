...
choices[ChoiceID.ARTISAN1] = Choice(ChoiceID.ARTISAN1, ResponseType.INDEX)
...
choices[ChoiceID.MINE2] = Choice(ChoiceID.MINE2, ResponseType.INDEX)
...
choices[ChoiceID.REMODEL2] = Choice(ChoiceID.REMODEL2, ResponseType.INDEX)
...
choices[ChoiceID.WORKSHOP] = Choice(ChoiceID.WORKSHOP, ResponseType.INDEX)
